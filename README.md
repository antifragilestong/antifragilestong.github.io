...
KC Wong Portfolio Site
    ...
    --It also presents KC's ojectives in future program developing.
    --It links to some recent finished website projects and allows readers to contact KC.
...
Emoji Animation Site
    --This page is an example page for showing how emojis up-and-down movement after the point
      hovering on the top. It's styled using CSS file. 